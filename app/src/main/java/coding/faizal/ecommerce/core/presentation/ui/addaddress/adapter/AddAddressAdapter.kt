package coding.faizal.ecommerce.core.presentation.ui.addaddress.adapter
...
class AddAddressAdapter (private val context : Context,
    ...
    inner class AddressViewHolder(val binding : ProductSizeItemBinding) : RecyclerView.ViewHolder(binding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when(viewType){
            ITEM_ACTUAL -> {
                return AddressViewHolder(ProductSizeItemBinding.inflate(LayoutInflater.from(parent.context),parent,false))
            }
            ITEM_SHIMMER -> {
