package coding.faizal.ecommerce.core.presentation.ui.favorite.screen
...
class FavoriteFragment : Fragment() {
    ...
    private val listProduct : MutableList<coding.faizal.ecommerce.core.domain.model.remote.product.Product> = mutableListOf()
    ...
    private fun setRvFavorite(result : List<coding.faizal.ecommerce.core.domain.model.remote.product.Product>){
