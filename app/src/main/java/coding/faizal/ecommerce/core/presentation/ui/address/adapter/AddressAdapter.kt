package coding.faizal.ecommerce.core.presentation.ui.address.adapter
...
class AddressAdapter (private val context : Context,
    ...
    interface AddressOnClick{
        ...
        fun moveToAdd(labelAddress: coding.faizal.ecommerce.core.domain.model.local.address.LabelAddress)
    }
}