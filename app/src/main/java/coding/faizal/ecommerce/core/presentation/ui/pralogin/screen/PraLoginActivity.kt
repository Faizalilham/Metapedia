package coding.faizal.ecommerce.core.presentation.ui.pralogin.screen
...
class PraLoginActivity : AppCompatActivity() {
    ...
    private fun doLogin(){
        binding.apply {
            btnLogin.setOnClickListener {
                ...
                authenticationViewModel.praLogin(email)
    ...
    private fun praLoginResult(){
        lifecycleScope.launch {
            authenticationViewModel.praLoginResult.collect{ resource ->
