package coding.faizal.ecommerce.core.presentation.ui.detailproduct.adapter
...
data class ProductColorAdapter(
    ...
    private val datas : List<coding.faizal.ecommerce.core.domain.model.local.product.ProductImage>,
    ...
    interface ProductImageOnClick{
        fun productImage(productImage : coding.faizal.ecommerce.core.domain.model.local.product.ProductImage, position : Int)
