package coding.faizal.ecommerce.core.presentation.ui.praregister.screen
...
import coding.faizal.ecommerce.presentation.viewmodel.authentication.AuthenticationViewModel
        ...
        binding.apply {
            btnRegister.setOnClickListener {
                ...
                lifecycleScope.launch {
                    authenticationViewModel.praRegisterResult.collect { resource ->
                ...
                authenticationViewModel.praRegister(email)
            }
        }
    }
