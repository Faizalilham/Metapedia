package coding.faizal.ecommerce.core.presentation.ui.help.adapter
...
class HelpAdapter(private val data : List<coding.faizal.ecommerce.core.domain.model.local.help.Help>) : RecyclerView.Adapter<HelpAdapter.HelpViewHolder>() {
