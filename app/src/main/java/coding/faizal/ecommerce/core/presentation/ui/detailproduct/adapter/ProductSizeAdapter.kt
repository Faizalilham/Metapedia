...
class ProductSizeAdapter (
    ...
    private val datas : List<coding.faizal.ecommerce.core.domain.model.local.product.ProductSize>,
    ...
    interface ProductSizeOnClick{
        fun productSize(productSize : coding.faizal.ecommerce.core.domain.model.local.product.ProductSize, position : Int)
    }
}