...
import coding.faizal.ecommerce.presentation.ui.home.utils.Utils.formatDateRanges
import com.bumptech.glide.Glide

class ProductAdapter(
    private var data : List<coding.faizal.ecommerce.core.domain.model.remote.product.Product>, private val listener : OnClickProduct
    ...
    inner class ProductViewHolder(val binding : ProductItemBinding ) : RecyclerView.ViewHolder(binding.root){
        fun bind(data : List<coding.faizal.ecommerce.core.domain.model.remote.product.Product>, position : Int){
            binding.apply {
                Glide.with(root)
    ...
    interface OnClickProduct{
        fun showBottomNav(data : coding.faizal.ecommerce.core.domain.model.remote.product.Product)
        fun productDetail( data : coding.faizal.ecommerce.core.domain.model.remote.product.Product)
    }
}