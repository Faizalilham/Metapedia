package coding.faizal.ecommerce.core.presentation.ui.editprofile.screen
...
class EditProfileActivity : AppCompatActivity() {
    ...
    private var i : coding.faizal.ecommerce.core.domain.model.remote.profileuser.ProfileUser? = null
    ...
    private fun getIntentDataUser(){
        i = intent.getParcelableExtra<coding.faizal.ecommerce.core.domain.model.remote.profileuser.ProfileUser>(ProfileActivity.PROFILE_DATA)
        i?.let {
            setupViewProfile(it)
            navigation(it)
        }
    ...
    private fun setupViewProfile(user : coding.faizal.ecommerce.core.domain.model.remote.profileuser.ProfileUser){
        binding.apply {
    ...
    private fun navigation(user : coding.faizal.ecommerce.core.domain.model.remote.profileuser.ProfileUser){
        binding.apply {
