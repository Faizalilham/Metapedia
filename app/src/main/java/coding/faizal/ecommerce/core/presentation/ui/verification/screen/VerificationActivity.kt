package coding.faizal.ecommerce.core.presentation.ui.verification.screen
...
import coding.faizal.ecommerce.presentation.viewmodel.verification.VerificationViewModel
...
class VerificationActivity : AppCompatActivity() {
    ...
    private fun setupViewEmail(){
        val dataIntent = intent.getParcelableExtra<coding.faizal.ecommerce.core.domain.model.remote.authentication.register.Register>(RegisterActivity.DATA_REGISTER)
        val dataIntent2 = intent.getParcelableExtra<coding.faizal.ecommerce.core.domain.model.remote.password.ForgetPassword>(ForgetPasswordActivity.FORGET_PASSWORD_DATA)
