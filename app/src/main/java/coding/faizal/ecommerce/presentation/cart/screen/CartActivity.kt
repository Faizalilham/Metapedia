package coding.faizal.ecommerce.presentation.cart.screen
...
import coding.faizal.ecommerce.presentation.cart.utils.Dummy
...
class CartActivity : AppCompatActivity() {
    ...
    private var products  = ArrayList<Dummy>(arrayListOf(Dummy("","",10.0f,false),Dummy("","",20.0f,false)))
