package coding.faizal.ecommerce.presentation.checkout.screen
...
import coding.faizal.ecommerce.presentation.checkout.adapter.CheckoutAdapter
import coding.faizal.ecommerce.presentation.checkout.utils.MidtransConfig
            ...
            productViewModel.productPaymentResult.collect{ resource ->
                when (resource) {
                    ...
                    is Resource.Success -> {
                        val result = resource.data
                        if (result != null) {
                            Toast.makeText(this@CheckoutActivity, result.token, Toast.LENGTH_SHORT).show()
                        }
                        if(result != null){
